...
class _ReportLostScreenState extends State<ReportLostScreen> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Date & Time Pickers
                _buildSectionTitle('Tanggal & Waktu Hilang'),
                const SizedBox(height: AppSpacing.sm),
  ...
  Widget _buildTypeBadge() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.lostBadge.withAlpha(25),
        borderRadius: BorderRadius.circular(AppRadius.md),
        border: Border.all(color: AppColors.lostBadge.withAlpha(76)),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const Icon(Icons.search_off, color: AppColors.lostBadge, size: 20),
  ...
  Widget _buildLocationPicker() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Lokasi Terakhir Terlihat', style: AppTextStyles.inputLabel),
        const SizedBox(height: AppSpacing.sm),
        GestureDetector(
          onTap: () async {
